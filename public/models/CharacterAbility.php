<?php
	class CharacterAbility extends Relation {
		static	$always_cached	= true;

		function image($path_only = false) {
			$path	= 'abilities/' . $this->character_id . '/' . $this->id . '.png';
		...
		function description() {
			return CharacterAbilityDescription::find_first('character_ability_id=' . $this->id . ' AND language_id=' . $_SESSION['language_id'], ['cache' => true]);
		}
		...
		function has_requirement($player) {
			...
			return ['has_requirement' => $ok, 'requirement_log' => $log];
		}
	}