...
<div class="tutorial-objectives">
    <?php	foreach($objectives as $objective): ?>
        <div class="tutorial" style="background-color:<?php echo $objective->complete ? '#092e4d':'#04192a'?>;">
            <div class="icon"><img src="<?php echo image_url('icons/'.($objective->complete ? 'accept':'cancel').'.png')?>" /></div>
            <div class="description">
                <b class="amarelo" style="font-size:14px;"><?php echo $objective->description()->name ?></b><br />
                <?php echo $objective->description()->description ?><br />
            </div>
            <div class="bar">
                <?php
                ...
                if($objective->achievement()->fragments==1){
                    ...
                    if($player_fragments){
                        if(($player_fragments->quantity < $objective->achievement()->quantity) && !$objective->complete){
                            echo exp_bar($player_fragments->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                        }else{
                            echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);

                        }
                    }else{
                        echo exp_bar('0 /'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }
                }
                if($objective->achievement()->fragments==2){
                    ...
                    if(($player_change->fragments < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player_change->fragments.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                ...
                if($objective->achievement()->map==1 && $objective->achievement()->anime_id){
                    ...
                    if((sizeof($player_map_anime) < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar(sizeof($player_map_anime).'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }
                }
                if($objective->achievement()->map==2 && $objective->achievement()->anime_id){
                    ...
                    if(($player_map_anime[0]['total'] < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar(($player_map_anime[0]['total'] ? $player_map_anime[0]['total'] : 0).'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }
                }
                ...
                if($objective->achievement()->friends > 1){
                    ...
                    if(($player_friends[0]['total'] < $objective->achievement()->friends) && !$objective->complete){
                        echo exp_bar($player_friends[0]['total'].'/'.$objective->achievement()->friends, $objective->achievement()->friends, 175);
                    }else{
                        echo exp_bar($objective->achievement()->friends.'/'.$objective->achievement()->friends, $objective->achievement()->friends, 175);

                    }
                }else if($objective->achievement()->friends == 1 && $objective->achievement()->friends_send_gifts){
                    ...
                    if(($player_send_gifts[0]['total'] < $objective->achievement()->friends_send_gifts) && !$objective->complete){
                        echo exp_bar($player_send_gifts[0]['total'].'/'.$objective->achievement()->friends_send_gifts, $objective->achievement()->friends_send_gifts, 175);
                    }else{
                        echo exp_bar($objective->achievement()->friends_send_gifts.'/'.$objective->achievement()->friends_send_gifts, $objective->achievement()->friends_send_gifts, 175);
                    }
                }else if($objective->achievement()->friends == 1 && $objective->achievement()->friends_received_gifts){
                    ...
                    if(($friends_received_gifts[0]['total'] < $objective->achievement()->friends_received_gifts) && !$objective->complete){
                        echo exp_bar($friends_received_gifts[0]['total'].'/'.$objective->achievement()->friends_received_gifts, $objective->achievement()->friends_received_gifts, 175);
                    }else{
                        echo exp_bar($objective->achievement()->friends_received_gifts.'/'.$objective->achievement()->friends_received_gifts, $objective->achievement()->friends_received_gifts, 175);
                ...
                if($objective->achievement()->level_player > 1){
                    ...
                    if(($player->level < $objective->achievement()->level_player) && !$objective->complete){
                        echo exp_bar($player->level.'/'.$objective->achievement()->level_player, $objective->achievement()->level_player, 175);
                    }else{
                        echo exp_bar($objective->achievement()->level_player.'/'.$objective->achievement()->level_player, $objective->achievement()->level_player, 175);
                    }
                }
                //Barrinhas de Progresso do Level
                ...
                if($objective->achievement()->treasure){
                    if(($player->treasure_total < $objective->achievement()->quantity) && !$objective->complete ){
                        echo exp_bar($player->treasure_total.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }
                }
                ...
                if($objective->achievement()->challenges > 0){
                    ...
                    if($player_challenge){
                        if(($player_challenge->quantity < $objective->achievement()->challenges_floor) && !$objective->complete){
                            echo exp_bar($player_challenge->quantity.'/'. $objective->achievement()->challenges_floor, $objective->achievement()->challenges_floor, 175);
                        }else{
                            echo exp_bar('1/1', 1, 175);
                        }
                    }else{
                        echo exp_bar('0/'. $objective->achievement()->challenges_floor, $objective->achievement()->challenges_floor, 175);
                    }
                }
                //Barrinhas de Progresso do Desafio do Ceu
                ...
                if($objective->achievement()->wanted==1){
                    ...
                    if(($player_wanted[0]['total'] < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player_wanted[0]['total'].'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }
                }
                if($objective->achievement()->wanted==2){
                    if(($player->won_last_battle < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player->won_last_battle.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }
                }
                ...
                if($objective->achievement()->level_account > 1){
                    if(($user->level < $objective->achievement()->level_account) && !$objective->complete){
                        echo exp_bar($user->level.'/'.$objective->achievement()->level_account, $objective->achievement()->level_account, 175);
                    }else{
                        echo exp_bar($objective->achievement()->level_account.'/'.$objective->achievement()->level_account, $objective->achievement()->level_account, 175);
                    }
                }
                //Barrinhas de Progresso dos Amigos
                ...
                if($objective->achievement()->equipment == 1 && $objective->achievement()->rarity){
                    ...
                    if(($player_equipments[0]['total'] < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player_equipments[0]['total'].'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }
                }
                ...
                if($objective->achievement()->currency){
                    if(($player->currency < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player->currency.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }
                }
                ...
                if($objective->achievement()->credits){
                    if(($user->credits < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($user->credits.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }
                }
                ...
                if($objective->achievement()->bloods==2){
                    ...
                    if(($player_change->bloods < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player_change->bloods.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }
                }
                ...
                if($objective->achievement()->sands==2){
                    ...
                    if(($player_change->sands < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player_change->sands.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                ...
                if($objective->achievement()->pets){
                    if($objective->achievement()->quantity && !$objective->achievement()->item_id && !$objective->achievement()->rarity && !$objective->achievement()->happiness){
                        ...
                        if(($total_pets < $objective->achievement()->quantity) && !$objective->complete){
                            echo exp_bar($total_pets.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                        }else{
                            echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                        }
                    }
                ...
                if($objective->achievement()->time_quests){
                    ...
                    if(($player_quest->time_total < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player_quest->time_total.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                ...
                if($objective->achievement()->battle_quests){
                    ...
                    if(($player_quest->combat_total < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player_quest->combat_total.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                ...
                if($objective->achievement()->pvp_quests){
                    ...
                    if(($player_quest->pvp_total < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player_quest->pvp_total.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                ...
                if($objective->achievement()->daily_quests){
                    ...
                    if(($player_quest->daily_total < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player_quest->daily_total.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                ...
                if($objective->achievement()->battle_npc){
                    if(($player->wins_npc < $objective->achievement()->quantity) && !$objective->complete){
                        echo exp_bar($player->wins_npc.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }else{
                        echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                    }
                }
                ...
                if($objective->achievement()->battle_pvp){
                    ...
                    if($objective->achievement()->battle_pvp && !$objective->achievement()->anime_id && !$objective->achievement()->character_id && !$objective->achievement()->faction_id){
                        if(($player->wins_pvp < $objective->achievement()->quantity) && !$objective->complete){
                            echo exp_bar($player->wins_pvp.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                        }else{
                            echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);

                        }
                        // Quer saber a quantidade de pvps com determinada facção
                    }else if($objective->achievement()->battle_pvp && !$objective->achievement()->anime_id && !$objective->achievement()->character_id && $objective->achievement()->faction_id){
                        ...
                        if(($player_achievement_stats[0]['total'] < $objective->achievement()->quantity) && !$objective->complete){
                            echo exp_bar(($player_achievement_stats[0]['total'] ? $player_achievement_stats[0]['total'] : 0).'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
                        }else{
                            echo exp_bar($objective->achievement()->quantity.'/'.$objective->achievement()->quantity, $objective->achievement()->quantity, 175);
...
echo partial('shared/info', [
    ...
    'message'	=> t('objectives.mensagens.description2', ['points' => $user->round_points])
]);
?>
<br />
<ul class="nav nav-pills nav-justified" id="luck-list-tabs">
    ...
    <?php foreach ($item_type_ids->result() as $item_type_id): ?>
        ...
        switch ($item_type_id->item_type_id){
            case 1:
                $name = t('objectives.item_types.1');
                break;
            case 2:
                $name = t('objectives.item_types.2');
                break;
            case 3:
                $name = t('objectives.item_types.3');
                break;
            case 4:
                $name = t('objectives.item_types.4');
                break;
            case 5:
                $name = t('objectives.item_types.5');
                break;
            case 6:
                $name = t('objectives.item_types.6');
                break;
            case 7:
                $name = t('objectives.item_types.7');
                break;
        }
        ?>
