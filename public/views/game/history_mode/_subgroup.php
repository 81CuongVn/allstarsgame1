...
<div class="history-mode-subgroup-list">
	<div class="msg-container-off">
			<div class="msg-h" style="background:url(<?=image_url($subgroup->image());?>); background-repeat: no-repeat;">
			</div>
			<div class="msgb-h" style="position:relative; margin-left: 231px; text-align: left; top: 36px">
				<b>
					<?=$subgroup->description()->name;?>
					<a class="btn btn-sm btn-primary pull-right show-battles" data-target="#<?=$npc_list_id;?>" data-show-text="<?=t('history_mode.show.show_battles');?>" data-hide-text="<?=t('history_mode.show.hide_battles');?>"><?=t('history_mode.show.show_battles');?></a>
				</b>
				<div class="content">
