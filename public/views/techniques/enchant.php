...
<div class="enchant">
	...
	<div class="enchant-item enchant-1 dropzone" data-slot="1">
		<?php if(isset($player_item_gem) && $player_item_gem){?>
			<img oncontextmenu="return false;" class="<?php echo $player_item_gem->gem_1 ? "remove-gem cursor_pointer" : ""?>" data-counter="1" data-item="<?php echo $item_equipped->id ?>" data-message="<?php echo t('enchant.message');?>" src="<?php echo image_url($player_item_gem->gem_1 ? "items/".$player_item_gem->gem_1.".png" : "enchant/".$item_combinations_item_1[0].".png")?>" />
		<?php }else{?>	
	...
	<div class="enchant-item enchant-2 dropzone" data-slot="2">
		<?php if(isset($player_item_gem) && $player_item_gem){?>
			<img oncontextmenu="return false;" class="<?php echo $player_item_gem->gem_2 ? "remove-gem cursor_pointer" : ""?>" data-counter="2" data-item="<?php echo $item_equipped->id ?>" data-message="<?php echo t('enchant.message');?>" src="<?php echo image_url($player_item_gem->gem_2 ? "items/".$player_item_gem->gem_2.".png" : "enchant/".$item_combinations_item_1[1].".png")?>" />
		<?php }else{?>	
			<img src="<?php echo image_url("enchant/sem-gem.png")?>" />
		<?php }?>
	</div>
	<div class="enchant-item enchant-3 dropzone" data-slot="3">
		<?php if(isset($player_item_gem) && $player_item_gem){?>
			<img oncontextmenu="return false;" class="<?php echo $player_item_gem->gem_3 ? "remove-gem cursor_pointer" : ""?>" data-counter="3" data-item="<?php echo $item_equipped->id ?>" data-message="<?php echo t('enchant.message');?>" src="<?php echo image_url($player_item_gem->gem_3 ? "items/".$player_item_gem->gem_3.".png" : "enchant/sem-gem.png")?>" />
		<?php }else{?>	
			<img src="<?php echo image_url("enchant/sem-gem.png")?>" />
		<?php }?>
	</div>
	<div class="enchant-item enchant-4 dropzone" data-slot="4">
		<?php if(isset($player_item_gem) && $player_item_gem){?>
			<img oncontextmenu="return false;" class="<?php echo $player_item_gem->gem_4 ? "remove-gem cursor_pointer" : ""?>" data-counter="4" data-item="<?php echo $item_equipped->id ?>" data-message="<?php echo t('enchant.message');?>" src="<?php echo image_url($player_item_gem->gem_4 ? "items/".$player_item_gem->gem_4.".png" : "enchant/sem-gem.png")?>" />
		<?php }else{?>	
			<img src="<?php echo image_url("enchant/sem-gem.png")?>" />
		<?php }?>
	</div>
