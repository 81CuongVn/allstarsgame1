...
<div id="dungeon-map-container" style="background-image: url(<?php echo image_url("maps/dungeon/1/" . $map->id . ".jpg" ) ?>); width: 730px; height: 730px; left: 7px;" data-key="<?php echo $_SESSION['guild_dungeon_key'] ?>" data-player="<?php echo $player->id ?>">
