...
<div id="pet-quests-list-content">
	...
	foreach ($quests as $quest) {
		$color		= $counter_cor%2 ? '091e30' : '173148';
		...
		<table width="725" border="0" cellpadding="0" cellspacing="0">
			<tr bgcolor="<?=$color;?>">
				<td colspan="3" align="center">
					<div class="name">
						<b class="<?=$quest->quest()->dificulty;?>" style="font-size:14px; position: relative; top: 5px;"><?=$quest->description()->name;?></b><br />
					</div><br />
				</td>
				<td rowspan="2" align="center" width="100">
					<b class="laranja" style="font-size:14px"><?=t('quests.time.header.duration');?></b><br />
					<?php
					if ($can_finish) {
						if ($success) { ?>
