						...
						if ($on_off != "on") {
							...
							if ($achievement->treasure) {
								if ($player->treasure_total < $achievement->quantity) {
									echo exp_bar($player->treasure_total, $achievement->quantity, 175, $player->treasure_total . '/' . $achievement->quantity);
								}
							}
							// Barrinhas de Progresso dos Tesouros
							...
							if ($achievement->wanted == 2) {
								if ($player->won_last_battle < $achievement->quantity) {
									echo exp_bar($player->won_last_battle, $achievement->quantity, 175, $player->won_last_battle . '/' . $achievement->quantity);
								}
							}
							// Barrinhas de Progresso dos wanted
							...
							if ($achievement->currency) {
								if ($player->currency < $achievement->quantity) {
									echo exp_bar($player->currency, $achievement->quantity, 175, $player->currency . '/' . $achievement->quantity);
								}
							}
							//Barrinhas de Progresso do Dinheiro
							...
							if ($achievement->credits) {
								if ($user->credits < $achievement->quantity) {
									echo exp_bar($user->credits, $achievement->quantity, 175, $user->credits . '/' . $achievement->quantity);
								}
							}
							// Barrinhas de Progresso das Estrelas
							...
							if ($achievement->battle_npc) {
								if ($player->wins_npc < $achievement->quantity) {
									echo exp_bar($player->wins_npc, $achievement->quantity, 175, $player->wins_npc . '/' . $achievement->quantity);
								}
							}
							// Barrinhas de Progresso de Batalha NPC
