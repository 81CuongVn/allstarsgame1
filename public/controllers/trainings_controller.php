<?php
	class TrainingsController extends Controller {
		...
		function __construct() {
			...
			// $this->consume_mana		= ($player->level / 2);
		...
		function attributes() {
			...
			$this->assign('consume_mana', round($this->consume_mana));
		...
		function distribute_attribute() {
			...
			$allowed_attributes	= array('for_atk', 'for_def', 'for_crit', 'for_abs', 'for_prec', 'for_init','for_inc_crit','for_inc_abs');
			$errors				= array();
