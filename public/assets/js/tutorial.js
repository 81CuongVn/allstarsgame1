	...
	Tour = (function() {
		function Tour(options) {
			...
			this._options = $.extend({
				...
				delay: false,
				basePath: '',
				template: `<div class="popover" style="width: 325px; background-color: #FFF; color: #000;">
					<div class="arrow arrow2"></div>
					<h3 class="popover-title" style="background-color: #f7f7f7; border-bottom: 1px solid #ebebeb;"></h3>
					<div class="popover-content" style="background-color: transparent;"></div>
